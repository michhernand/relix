function(compile_attributes)
	...
	ELSE()
		message(WARN ${rcmd_compile_output})
		message(WARN ${rcmd_compile_error})
...
function(compile_documentation)
	...
	ELSE()
		message(WARN ${rcmd_doc_output})
		message(WARN ${rcmd_doc_error})
...
function(build_r_lib)
	...
	ELSE()
		message(WARN ${rcmd_build_output})
		message(WARN ${rcmd_build_error})
		message(FATAL_ERROR "Build of R Library (FAILED STATUS!=0)")
	ENDIF()
endfunction()
...
function(install_r_lib)
	...
	ELSE()
		message(WARN ${rcmd_install_output})
		message(WARN ${rcmd_install_error})
